...
<p class="subHeader">Analisa Mata Pelajaran Tingkatan / Tahun<font color="#FFFFFF">(Tarikh Kemaskini 23/6/2015 11:23 AM)</font></p>
...
?> 
<br><br>
&nbsp;&nbsp;<input type="button" name="cetak" value="CETAK" onClick="document.f1.action='ctk_analisis_mptingmrdaerah.php?<?php echo "ting=$ting&tahun=$tahun&jpep=$jpep";?>';document.f1.submit();">
<input type="button" name="export" value="EXPORT KE EXCEL" onclick="document.f1.action='analisis_mptingmrdaerah_excel.php?<?php echo "ting=$ting&tahun=$tahun&jpep=$jpep";?>';document.f1.submit();" />
</form>
