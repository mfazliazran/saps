...
{		
	...
	switch ($ting)
	{
		case "D1": case "D2" : case "D3": case "D4" :case "D5" : case "D6" :
			if($kelas<>"")
				location("lembaran_markahadminsr.php?ting=$ting&&kelas=$kelas");//&&namaguru=$namagu&&tingkatan=$tingkatan&&namasekolah=$namasek");
			else
				location("lembaran_markahadminsr.php?ting=$ting&&kelas=$kelas");
			break;
		case "P": case "T1": case "T2": case "T3":
			if($kelas<>"")
				location("lembaran_markahadminmr.php?ting=$ting&&kelas=$kelas");//&&namaguru=$namagu&&tingkatan=$tingkatan&&namasekolah=$namasek");
			else
				location("lembaran_markahadminmr.php?ting=$ting&kelas=$kelas");
			break;
		case "T4": case "T5":
			if($kelas<>"")
				location("lembaran_markahadminma.php?ting=$ting&&kelas=".urlencode($kelas)."");//&&namaguru=$namagu&&tingkatan=$tingkatan&&namasekolah=$namasek");
			else
				location("lembaran_markahadminma.php?ting=$ting&kelas=$kelas");
			break;
	}
} 
else {
		...
		self.location='lembaran-markahadmin.php?ting=' + val;
		}
		</script>
		<?php
		...
		echo "<form method=post name='f1' action='lembaran-markahadmin.php'>";
