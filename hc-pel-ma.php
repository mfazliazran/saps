...
<p class="subHeader">Analisis Headcount Mata Pelajaran</p>
<?php
...
if (isset($_POST['hc']))
{
	...
	OCIExecute($qnamamp);
	OCIFetch($qnamamp);
	$namamp=OCIResult($qnamamp,"MP");

	if(($ting !='') AND($mp != '')) {
		echo "<h3><center>ANALISIS HEADCOUNT MATA PELAJARAN MENGIKUT $tajuk<br>TAHUN $tahun</center></h3>\n";
		echo "<table align=\"center\" width=\"98%\"  border=\"0\" cellpadding=\"6\" cellspacing=\"0\" bordercolor=\"#999999\">\n";
		echo "<tr><td><b>SEKOLAH :</b> $namasek</td></tr>\n";
		echo "<tr><td><b>$tajuk :</b> $ting</td></tr>\n";
		echo "<tr><td><b>MATA PELAJARAN :</b> $namamp</td></tr>\n";
		echo "</table>";
		echo " <br>";
...
////////////////////////////////////////// BLOK MENENGAH RENDAH & SEKOLAH RENDAH  ///////////////////////////////////////////////////////////
	...
	if (($level=="MR") OR ($level=="SR")){
		...
		$qbcalon = "SELECT * FROM $theadcount WHERE tahun='$tahun' AND kodsek='$kodsek' AND $tahap='$ting' AND hmp='$mp' and gtov is not null";
		//echo $qbcalon."<br>";
		$qbc = OCIParse($conn_sispa,$qbcalon);
		OCIExecute($qbc);
		$bilcalon = count_row($qbcalon);
		
		$biltovA = $biltovB = $biltovC = $biltovD = $biltovE = $biltovF = $biltovTH = $biltovL = 0;
		$bilotr1A = $bilotr1B = $bilotr1C = $bilotr1D = $bilotr1E = $bilotr1F = $bilotr1TH = $bilotr1L = 0;
		$bilotr2A = $bilotr2B = $bilotr2C = $bilotr2D = $bilotr2E = $bilotr2F = $bilotr2TH = $bilotr2L = 0;
		$bilotr3A = $bilotr3B = $bilotr3C = $bilotr3D = $bilotr3E = $bilotr3F = $bilotr3TH = $bilotr3L = 0;
		$bilatr1A = $bilatr1B = $bilatr1C = $bilatr1D = $bilatr1E = $bilatr1F = $bilatr1TH = $bilatr1L = 0;
		$bilatr2A = $bilatr2B = $bilatr2C = $bilatr2D = $bilatr2E = $bilatr2F = $bilatr2TH = $bilatr2L = 0;
		$bilatr3A = $bilatr3B = $bilatr3C = $bilatr3D = $bilatr3E = $bilatr3F = $bilatr3TH = $bilatr3L = 0;
		$biletrA = $biletrB = $biletrC = $biletrD = $biletrE = $biletrF = $biletrTH = $biletrL = 0;
		/////////////////////////////////////// CARI BIL TOV BARU ////////////////////////
		while (OCIFetch($qbc))
		{
			switch (/*$rowhc['gtov']*/OCIResult($qbc,"GTOV"))
			{
				...
				case 'F'  : $biltovF = $biltovF + 1; break;
				case 'TH' : $biltovTH = $biltovTH + 1; break;
			}
			switch (OCIResult($qbc,"GOTR1"))
			{
				...
				case 'F'  : $bilotr1F = $bilotr1F + 1; break;
				case 'TH' : $bilotr1TH = $bilotr1TH + 1; break;
			}
			switch (OCIResult($qbc,"GOTR2"))
			{
				...
				case 'F'  : $bilotr2F = $bilotr2F + 1; break;
				case 'TH' : $bilotr2TH = $bilotr2TH + 1; break;
			}
			switch (OCIResult($qbc,"GOTR3"))
			{
				...
				case 'F'  : $bilotr3F = $bilotr3F + 1; break;
				case 'TH' : $bilotr3TH = $bilotr3TH + 1; break;
			}
			switch (OCIResult($qbc,"GETR"))
			{
				...
				case 'F'  : $biletrF = $biletrF + 1; break;
		...
		{ 
			if($tahun<=2014){
				...
				$biltovL = $biltovA + $biltovB + $biltovC + $biltovD + $biltovE;
				$bilotr1L = $bilotr1A + $bilotr1B + $bilotr1C + $bilotr1D + $bilotr1E;
				$bilotr2L = $bilotr2A + $bilotr2B + $bilotr2C + $bilotr2D + $bilotr2E;
				$bilotr3L = $bilotr3A + $bilotr3B + $bilotr3C + $bilotr3D + $bilotr3E;
				$biletrL = $biletrA + $biletrB + $biletrC + $biletrD + $biletrE;
			}
		}
		...
		OCIFetch($qrytentuhcatr1);	
		$jpepatr1=OCIResult($qrytentuhcatr1,"JENPEP"); 
		$tahunatr1=OCIResult($qrytentuhcatr1,"TAHUNTOV"); 
		$tingatr1=OCIResult($qrytentuhcatr1,"TINGTOV");
		$qryatr1 = "SELECT * FROM $tmarkah WHERE kodsek='".$_SESSION['kodsek']."' AND $tahap='$tingatr1' AND jpep='$jpepatr1' AND tahun='$tahunatr1' AND $mp IS NOT NULL";
		$qry = OCIParse($conn_sispa,$qryatr1);
		OCIExecute($qry);
		$bilatr1 = count_row($qryatr1);
		while (OCIFetch($qry))
		{
			switch (OCIResult($qry,"$gmp"))
			{
				...
				case 'F'  : $bilatr1F = $bilatr1F + 1; break;
				case 'TH' : $bilatr1TH = $bilatr1TH + 1; break;
			}
		}
		if ($level == "MR"){
			if($tahun<=2014){ 
				$bilatr1L = $bilatr1A + $bilatr1B + $bilatr1C + $bilatr1D; 
			}else{//2015 ke atas
				$bilatr1L = $bilatr1A + $bilatr1B + $bilatr1C + $bilatr1D + $bilatr1E; 
			}
		}
		if ($level == "SR"){ 
			if($tahun<=2014){
				$bilatr1L = $bilatr1A + $bilatr1B + $bilatr1C; 
			}elseif($tahun==2015){
				if($ting=="D6"){
					$bilatr1L = $bilatr1A + $bilatr1B + $bilatr1C; 
				}else{//D1-D5
		...
		$qrytentuhcatr2 = "SELECT * FROM tentu_hc WHERE tingpep='$ting' AND tahunpep='".$_SESSION['tahun']."' AND capai='ATR2'";
		$qry2 = OCIParse($conn_sispa,$qrytentuhcatr2);
		OCIExecute($qry2);
		OCIFetch($qry2);	
		$jpepatr2=OCIResult($qry2,"JENPEP"); 
		$tahunatr2=OCIResult($qry2,"TAHUNTOV"); 
		$tingatr2=OCIResult($qry2,"TINGTOV");
		$qryatr2 =  "SELECT * FROM $tmarkah WHERE kodsek='".$_SESSION['kodsek']."' AND $tahap='$tingatr2' AND jpep='$jpepatr2' AND tahun='$tahunatr2' AND $mp IS NOT NULL";
		$qry_2 = OCIParse($conn_sispa,$qryatr2);
		OCIExecute($qry_2);
		$bilatr2 = count_row($qryatr2);
		while (OCIFetch($qry_2))
		{
			switch (OCIResult($qry_2,"$gmp"))
			{
				...
				case 'F'  : $bilatr2F = $bilatr2F + 1; break;
				case 'TH' : $bilatr2TH = $bilatr2TH + 1; break;
			}
		}
		if ($level == "MR"){ 
			if($tahun<=2014){
				$bilatr2L = $bilatr2A + $bilatr2B + $bilatr2C + $bilatr2D; 
			}else{
				$bilatr2L = $bilatr2A + $bilatr2B + $bilatr2C + $bilatr2D + $bilatr2E; 
			}
		}
		if ($level == "SR"){ 
			if($tahun<=2014){
				$bilatr2L = $bilatr2A + $bilatr2B + $bilatr2C; 
			}elseif($tahun==2015){
				if($ting=="D6"){
					$bilatr2L = $bilatr2A + $bilatr2B + $bilatr2C; 	
				}else{//D1-D5
		...
		$jpepatr3=OCIResult($qrytentuhcatr3,"JENPEP"); 
		$tahunatr3=OCIResult($qrytentuhcatr3,"TAHUNTOV"); 
		$tingatr3=OCIResult($qrytentuhcatr3,"TINGTOV");
		$qryatr3 = "SELECT * FROM $tmarkah WHERE kodsek='".$_SESSION['kodsek']."' AND tahun='$tahunatr3' AND $tahap='$tingatr3' AND jpep='$jpepatr3' AND $mp IS NOT NULL";
		$qry3 = OCIParse($conn_sispa,$qryatr3);
		OCIExecute($qry3);
		$bilatr3 = count_row($qryatr3);
		while (OCIFetch($qry3))
		{
			switch (OCIResult($qry3,"$gmp"))
			{
				...
				case 'F'  : $bilatr3F = $bilatr3F + 1; break;
				case 'TH' : $bilatr3TH = $bilatr3TH + 1; break;
			}
		}
		if ($level == "MR"){ 
			if($tahun<=2014){
				$bilatr3L = $bilatr3A + $bilatr3B + $bilatr3C + $bilatr3D; 
			}else{
				$bilatr3L = $bilatr3A + $bilatr3B + $bilatr3C + $bilatr3D + $bilatr3E; 
			}
		}
		if ($level == "SR"){
			if($tahun<=2014){
				$bilatr3L = $bilatr3A + $bilatr3B + $bilatr3C;
			}elseif($tahun==2015){
				if($ting=="D6"){
					$bilatr3L = $bilatr3A + $bilatr3B + $bilatr3C;	
				}else{//D1-D5
		...
		if ($bilcalon != 0){
			...
			$peratustovF = number_format(($biltovF/($bilcalon - $biltovTH))*100,2,'.',',');
			...
			/*if($tahun!=2015)
				...
				$gpktov = number_format((($biltovA*1)+($biltovB*2)+($biltovC*3)+($biltovD*4)+($biltovE*5)+($biltovF*6))/($bilcalon - $biltovTH),2,'.',',');*/
			if ($level == "MR"){ 
				if($tahun<=2014){
					$gpktov = number_format((($biltovA*1)+($biltovB*2)+($biltovC*3)+($biltovD*4)+($biltovE*5))/($bilcalon - $biltovTH),2,'.',',');
				}else{
					$gpktov = number_format((($biltovA*1)+($biltovB*2)+($biltovC*3)+($biltovD*4)+($biltovE*5)+($biltovF*6))/($bilcalon - $biltovTH),2,'.',',');
					//echo "$biltovA = $biltovB = $biltovC = $biltovD = $biltovE = $biltovF = $biltovTH = $biltovL <br>";
				}
			}
			...
			if ($level == "SR"){
				if($tahun<=2014){
					...
					$gpktov = number_format((($biltovA*1)+($biltovB*2)+($biltovC*3)+($biltovD*4)+($biltovE*5)+($biltovTH*5))/($bilcalon - $biltovTH),2,'.',',');		
				}
			}
			...
			$peratusotr1F = number_format(($bilotr1F/($bilcalon - $bilotr1TH))*100,2,'.',',');
			...
			/*if($tahun!=2015)		
				...
				$gpkotr1 = number_format((($bilotr1A*1)+($bilotr1B*2)+($bilotr1C*3)+($bilotr1D*4)+($bilotr1E*5)+($bilotr1F*6))/($bilcalon - $bilotr1TH),2,'.',',');*/
			if ($level == "MR"){ 
				if($tahun<=2014){
					$gpkotr1 = number_format((($bilotr1A*1)+($bilotr1B*2)+($bilotr1C*3)+($bilotr1D*4)+($bilotr1E*5))/($bilcalon - $bilotr1TH),2,'.',',');
				}else{
			...
			$peratusotr2F = number_format(($bilotr2F/($bilcalon - $bilotr2TH))*100,2,'.',',');
			...
			/*if($tahun!=2015)
				...
				$gpkotr2 = number_format((($bilotr2A*1)+($bilotr2B*2)+($bilotr2C*3)+($bilotr2D*4)+($bilotr2E*5)+($bilotr2F*6))/($bilcalon - $bilotr2TH),2,'.',',');*/
			if ($level == "MR"){ 
				if($tahun<=2014){
					$gpkotr2 = number_format((($bilotr2A*1)+($bilotr2B*2)+($bilotr2C*3)+($bilotr2D*4)+($bilotr2E*5))/($bilcalon - $bilotr2TH),2,'.',',');
				}else{
			...
			$peratusotr3F = number_format(($bilotr3F/($bilcalon - $bilotr3TH))*100,2,'.',',');
			...
			/*if($tahun!=2015)
				...
				$gpkotr3 = number_format((($bilotr3A*1)+($bilotr3B*2)+($bilotr3C*3)+($bilotr3D*4)+($bilotr3E*5)+($bilotr3F*6))/($bilcalon - $bilotr3TH),2,'.',',');*/
			if ($level == "MR"){ 
				if($tahun<=2014){
					$gpkotr3 = number_format((($bilotr3A*1)+($bilotr3B*2)+($bilotr3C*3)+($bilotr3D*4)+($bilotr3E*5))/($bilcalon - $bilotr3TH),2,'.',',');
				}else{
			...
			/*if($tahun!=2015)
				...
				$gpketr = number_format((($biletrA*1)+($biletrB*2)+($biletrC*3)+($biletrD*4)+($biletrE*5)+($biletrF*6))/($bilcalon - $biletrTH),2,'.',',');*/
			if ($level == "MR"){ 
				if($tahun<=2014){
					$gpketr = number_format((($biletrA*1)+($biletrB*2)+($biletrC*3)+($biletrD*4)+($biletrE*5))/($bilcalon - $biletrTH),2,'.',',');
				}else{
			...
			$peratustovA = $peratustovB = $peratustovC = $peratustovD = $peratustovL = $peratustovE = $peratustovF =  0.00; 
			$peratusotr1A = $peratusotr1B = $peratusotr1C = $peratusotr1D = $peratusotr1L = $peratusotr1E = $peratusotr1F = 0.00;
			$peratusotr2A = $peratusotr2B = $peratusotr2C = $peratusotr2D = $peratusotr2L = $peratusotr2E = $peratusotr2F = 0.00;
			$peratusotr3A = $peratusotr3B = $peratusotr3C = $peratusotr3D = $peratusotr3L = $peratusotr3E = $peratusotr3F = 0.00;
			$peratusetrA = $peratusetrB = $peratusetrC = $peratusetrD = $peratusetrL = $peratusetrE = $peratusetrF = 0.00;
		...
		if ($bilatr1 != 0){
			...
			$peratusatr1F = number_format(($bilatr1F/($bilatr1 - $bilatr1TH))*100,2,'.',',');
			...
			/*if($tahun!=2015)
				...
				$gpkatr1 = number_format((($bilatr1A*1)+($bilatr1B*2)+($bilatr1C*3)+($bilatr1D*4)+($bilatr1E*5)+($bilatr1F*6))/($bilatr1 - $bilatr1TH),2,'.',',');*/
			if ($level == "MR"){ 
				if($tahun<=2014){
					$gpkatr1 = number_format((($bilatr1A*1)+($bilatr1B*2)+($bilatr1C*3)+($bilatr1D*4)+($bilatr1E*5))/($bilatr1 - $bilatr1TH),2,'.',',');
				}else{
		...
		} else { $gpkatr1 = $peratusatr1A = $peratusatr1B = $peratusatr1C = $peratusatr1D = $peratusatr1L = $peratusatr1E = $peratusatr1F =  0.00;  }
		...
		if ($bilatr2 != 0){
			...
			$peratusatr2F = number_format(($bilatr2F/($bilatr2 - $bilatr2TH))*100,2,'.',',');
			...
			/*if($tahun!=2015)
				...
				$gpkatr2 = number_format((($bilatr2A*1)+($bilatr2B*2)+($bilatr2C*3)+($bilatr2D*4)+($bilatr2E*5)+($bilatr2F*6))/($bilatr2 - $bilatr2TH),2,'.',',');*/
			if ($level == "MR"){ 
				if($tahun<=2014){
					$gpkatr2 = number_format((($bilatr2A*1)+($bilatr2B*2)+($bilatr2C*3)+($bilatr2D*4)+($bilatr2E*5))/($bilatr2 - $bilatr2TH),2,'.',',');
				}else{
		...
		} else { $gpkatr2 = $peratusatr2A = $peratusatr2B = $peratusatr2C = $peratusatr2D = $peratusatr2L = $peratusatr2E = $peratusatr2F =  0.00;  }
		...
		if ($bilatr3 != 0){
			...
			$peratusatr3F = number_format(($bilatr3F/($bilatr3 - $bilatr3TH))*100,2,'.',',');
			...
			/*if($tahun!=2015)
				...
				$gpkatr3 = number_format((($bilatr3*1)+($bilatr3B*2)+($bilatr3C*3)+($bilatr3D*4)+($bilatr3E*5)+($bilatr3F*6))/($bilatr3 - $bilatr3TH),2,'.',',');*/
			if ($level == "MR"){ 
				if($tahun<=2014){
					$gpkatr3 = number_format((($bilatr3A*1)+($bilatr3B*2)+($bilatr3C*3)+($bilatr3D*4)+($bilatr3E*5))/($bilatr3 - $bilatr3TH),2,'.',',');
				}else{
					$gpkatr3 = number_format((($bilatr3A*1)+($bilatr3B*2)+($bilatr3C*3)+($bilatr3D*4)+($bilatr3E*5)+($bilatr3F*6))/($bilatr3 - $bilatr3TH),2,'.',',');
				}
			}
			if ($level == "SR"){
				if($tahun<=2014){
					...
					$gpkatr3 = number_format((($bilatr3A*1)+($bilatr3B*2)+($bilatr3C*3)+($bilatr3D*4)+($bilatr3E*5))/($bilatr3 - $bilatr3TH),2,'.',',');
					//echo "((($bilatr3A*1)+($bilatr3B*2)+($bilatr3C*3)+($bilatr3D*4)+($bilatr3E*5))/($bilatr3 - $bilatr3TH)";
				}
			}
		} else { $gpkatr3 = $peratusatr3A = $peratusatr3B = $peratusatr3C = $peratusatr3D = $peratusatr3L = $peratusatr3E = $peratusatr3F =  0.00;  }
		...
		if($tahun==2015){
			if($ting=='D6'){
				...
				echo "<td><div align=\"center\">$biltovF</div></td>\n";
				echo "<td><div align=\"center\">$peratustovF</div></td>\n";
			}			
		}else{
			if($level=="MR"){
				echo "<td><div align=\"center\">$biltovF</div></td>\n";
		...
		if($tahun==2015){
			if($ting=='D6'){
				...
				echo "<td><div align=\"center\">$bilotr1F</div></td>\n";
				echo "<td><div align=\"center\">$peratusotr1F</div></td>\n";	
			}
		}else{
			if($level=="MR"){
			echo "<td><div align=\"center\">$bilotr1F</div></td>\n";
		...
		if($tahun==2015){
			if($ting=='D6'){
				...
				echo "<td><div align=\"center\">$bilatr1F</div></td>\n";
				echo "<td><div align=\"center\">$peratusatr1F</div></td>\n";	
			}
		}else{
			if($level=="MR"){
			echo "<td><div align=\"center\">$bilatr1F</div></td>\n";
		...
		if($tahun==2015){
			if($ting=='D6'){
				...
				echo "<td><div align=\"center\">$bilotr2F</div></td>\n";
				echo "<td><div align=\"center\">$peratusotr2F</div></td>\n";	
			}
		}else{
			if($level=="MR"){
			echo "<td><div align=\"center\">$bilotr2F</div></td>\n";
		...
		if($tahun==2015){
			if($ting=='D6'){
				...
				echo "<td><div align=\"center\">$bilatr2F</div></td>\n";
				echo "<td><div align=\"center\">$peratusatr2F</div></td>\n";	
			}
		}else{
			if($level=="MR"){
			echo "<td><div align=\"center\">$bilatr2F</div></td>\n";
		...
		if($tahun==2015){
			if($ting=='D6'){
				...
				echo "<td><div align=\"center\">$bilotr3F</div></td>\n";
				echo "<td><div align=\"center\">$peratusotr3F</div></td>\n";	
			}
		}else{
			if($level=="MR"){
			echo "<td><div align=\"center\">$bilotr3F</div></td>\n";
		...
		if($tahun==2015){
			if($ting=='D6'){
				...
				echo "<td><div align=\"center\">$bilatr3F</div></td>\n";
				echo "<td><div align=\"center\">$peratusatr3F</div></td>\n";	
			}
		}else{
			if($level=="MR"){
			echo "<td><div align=\"center\">$bilatr3F</div></td>\n";
...
////////////////////////////////////  BLOK MENENGAH ATAS  ///////////////////////////////////////////////////////////////////////
	...
	if ($level=="MA"){
		...
		$qbcalon = "SELECT * FROM $theadcount WHERE kodsek='$kodsek' AND tahun='$tahun' AND $tahap='$ting' AND hmp='$mp' AND gtov is not null";
		//echo "SELECT * FROM $theadcount WHERE kodsek='$kodsek' AND tahun='$tahun' AND $tahap='$ting' AND hmp='$mp' AND gtov is not null";
		$qbc = OCIParse($conn_sispa,$qbcalon);
		OCIExecute($qbc);
		$bilcalon = count_row($qbcalon);
		...
		while(OCIFetch($qbc))
		{
			...
			switch (/*$rowhc['gotr1']*/trim(OCIResult($qbc,"GOTR1")))
			{	
		...
		$qrytentuhcatr1 = OCIParse($conn_sispa,"SELECT jenpep,tahuntov,tingtov FROM tentu_hc WHERE tingpep='$ting' AND tahunpep='".$_SESSION['tahun']."' AND capai='ATR1'");
		OCIExecute($qrytentuhcatr1);
		$rowtentuatr1=oci_fetch_array($qrytentuhcatr1);	//$rowtentuatr1
		$jpepatr1=$rowtentuatr1['JENPEP']; 
		$tahunatr1=$rowtentuatr1["TAHUNTOV"]; 
		$tingatr1=$rowtentuatr1['TINGTOV'];
		
		$qryatr1 = "SELECT * FROM markah_pelajar WHERE kodsek='".$_SESSION['kodsek']."' AND tahun='$tahunatr1' AND $tahap='$tingatr1' AND jpep='$jpepatr1' AND $mp IS NOT NULL";// $mp!=''";
		$qry = OCIParse($conn_sispa,$qryatr1);
		OCIExecute($qry);
		$bilatr1 = count_row($qryatr1);
		while (OCIFetch($qry))
		{
			switch (trim(OCIResult($qry,"$gmp")))
			{	
		...
		$bilatr1L = $bilatr11AA + $bilatr11A + $bilatr12A + $bilatr13B + $bilatr14B + $bilatr15C + $bilatr16C + $bilatr17D ;
		...
		$qryatr2 = "SELECT * FROM markah_pelajar WHERE kodsek='".$_SESSION['kodsek']."' AND tahun='$tahunatr2' AND $tahap='$tingatr2' AND jpep='$jpepatr2' AND $mp IS NOT NULL";// $mp!=''";
		$qry2 = OCIParse($conn_sispa,$qryatr2);
		OCIExecute($qry2);
		$bilatr2 = count_row($qryatr2);
		while (OCIFetch($qry2))
		{
			switch (trim(OCIResult($qry2,"$gmp"))/*$rowatr2["$gmp"]*/)
			{	
		...
		$bilatr2 = $bilatr21AA + $bilatr21A + $bilatr22A + $bilatr23B + $bilatr24B + $bilatr25C + $bilatr26C + $bilatr27D + $bilatr28E  + $bilatr29G + $bilatr2TH;
		...
		$jpepatr3=trim(OCIResult($qrytentuhcatr3,"JENPEP"))/*$rowtentuatr3['jenpep']*/; $tahunatr3=/*$rowtentuatr3['tahuntov']*/trim(OCIResult($qrytentuhcatr3,"TAHUNTOV")); $tingatr3=/*$rowtentuatr3['tingtov']*/trim(OCIResult($qrytentuhcatr3,"TINGTOV"));
		$qryatr3 = "SELECT * FROM markah_pelajar WHERE kodsek='".$_SESSION['kodsek']."' AND tahun='$tahunatr3' AND $tahap='$tingatr3' AND jpep='$jpepatr3' AND $mp IS NOT NULL";//$mp!=''";
		$qry3 = OCIParse($conn_sispa,$qryatr3);
		OCIExecute($qry3);
		$bilatr3 = count_row($qryatr3);
		while (OCIFetch($qry3))
		{
			switch (trim(OCIResult($qry3,"$gmp"))/*$rowatr3["$gmp"]*/)
			{
		...
		if ($bilatr1 != 0){
			...
			//$gpkatr1 = gpmpma($bilatr11AA,$bilatr11A,$bilatr12A,$bilatr13B,$bilatr14B,$bilatr15C,$bilatr16C,$bilatr17D,$bilatr18E,$bilatr19G,($bilatr1 - $bilatr1TH));
...
/////////////////////////////////////// ETR ///////////////////////////////
	...
	echo "<br><br>";
			...
			echo "    <td bgcolor=\"#FFFF99\"><div align=\"center\"><h3>SILA PILIH $tajuk DAN MATA PELAJARAN</h3><br>\n";

			echo "      <br>\n";

			echo "      << <a href=\"hc-pel-ma.php\">Kembali</a></td>\n";
...
function reload(form)
{
	...
	self.location='hc-pel-ma.php?ting=' + val ;
}
</script>
<?php
	$ting=$_GET['ting'];
	
	echo " <center><h3>SILA PILIH $tajuk DAN MATA PELAJARAN</h3></center>";
//	echo "<form method=\"post\">\n"; target=\"_blank\"
	echo "<form method=\"post\" action=\"hc-pel-ma.php\">";
	echo "<table  border=\"1\" bordercolor=\"#FFFFFF\" width=\"300\"  border=\"0\" align=\"center\" cellpadding=\"10\" cellspacing=\"0\">\n";
	echo "  <tr bgcolor=\"#CCCCCC\">\n";
	echo "  <td><center>$tajuk</center></td>\n";
	echo "  <td><center>MATA PELAJARAN</center></td>\n";
	echo "  <td></td>\n";
	echo " </tr>";
	echo "  <tr bgcolor=\"#CCCCCC\">\n";
	echo "  <td>\n";
	...
	while(OCIFetch($mpSQL)) { //$noticia
		$kodsub = OCIResult($mpSQL,"HMP");
		$tempmpSQL = "SELECT * FROM $tmatap WHERE kod ='$kodsub'";
		$temprs_mp = OCIParse($conn_sispa,$tempmpSQL);
		OCIExecute($temprs_mp);
		OCIFetch($temprs_mp); //$tempmp
	...
	echo "<td>";
	echo "<input type='submit' name=\"hc\" value=\"Hantar\">";
	echo "</td>";
	echo "</form>";
