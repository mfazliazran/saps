...
<table width="1216"  align="center" border="0">
  ...
  <tr> 
    <td height="300"><font size="3" color="#FF0000"><strong> 
      <center>
        <table width="509" height="32" border="0">
          <tr> 
            <td width="503"><strong><font size="2" color="#FF0000"><blink> KOD 
              AKSES ATAU KATA LALUAN SALAH !!!, SILA LOGIN SEMULA <img src="images/saps2012/warning_icon_small.gif" width="21" height="22" /></blink></font></strong></td>
          </tr>
        </table>
      </center>
      </strong> <table width="1209" border="0">
        <tr> 
          ...
          <td width="486" valign="top"> <table width="437" align="center" height="234" border="0">
              <tr> 
