...
<p class="subHeader">Daftar Pengetua / Guru Besar</p>
<?php
echo "<br><br>";

$q_guru = "SELECT * FROM login WHERE kodsek='$kodsek' AND level1='P'";
$qry_guru = OCIParse($conn_sispa,$q_guru);
OCIExecute($qry_guru);
OCIFetch($qry_guru); // rowg

echo "<form name=\"form1\" method=\"post\" action=\"daftar_pengetua.php\">\n";
		...
		echo "<center><b>NAMA PENGETUA / GURU BESAR</b></center><br><br>";
		...
		echo "<td><a href=hapus_pengetua.php?data=".OCIResult($qry_guru,"NOKP")."><center><img src = images/drop.png width=12 height=13 Alt=\"Hapus\" border=0></center></a></td>\n";
		echo "  </tr>\n";
