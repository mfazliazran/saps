...
<form action="ctk_lembaran-markah-jpn.php?ting=<?php echo $m;?>" method="POST" target="_blank">
...
<input type="button" name="export" value="EXPORT KE EXCEL" onclick="open_window('data-lembaran-markah-excel-jpn.php?ting=<?php echo $m;?>','win1');" />
</form>
<?php
include 'kaki.php';
function tahap($ting)
