...
<p class="subHeader">Senarai Sekolah Berprestasi Tinggi</p>
<?php 
...
<?php
echo "<br>";
echo "<center><h3>SENARAI SEKOLAH SBT</center></h3><br>";
...
<?php
paging($totalrecord,$recordpage,"senarai_seksbt.php?cari=1",$pg);
