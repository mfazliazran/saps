...
$q_nting = "SELECT *  FROM tnilai_smr mr, tmurid tm WHERE mr.tahun='$tahun' AND mr.jpep='$jpep' AND mr.kodsek='$kodsek' AND mr.ting='$ting' AND mr.nokp=tm.nokp and tm.kodsek$ting='$kodsek' and kodsek_semasa='$kodsek' ORDER BY mr.keputusan Desc, mr.gpc Asc, mr.peratus Desc";
