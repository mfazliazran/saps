...
//echo "SELECT * FROM tguru_kelas gk, tsekolah ts WHERE gk.tahun='".$_SESSION['tahun']."' AND gk.kodsek='".$_SESSION['kodsek2']."' AND gk.ting='$ting' AND gk.kelas='".oci_escape_string($kelas)."' AND gk.kodsek=ts.kodsek";
OCIExecute($q_guru);
OCIFetch($q_guru);
...
AND mkh.tahun='$tahun' AND mkh.ting='$ting' AND mkh.jpep='$jpep' ORDER BY mr.keputusan Desc, mr.gpc ASC, mr.peratus DESC");
oci_execute($q_mkdt);
...
mkh.tahun='$tahun' AND mkh.ting='$ting' AND mkh.jpep='$jpep' ORDER BY mr.keputusan Desc, mr.gpc ASC, mr.peratus DESC");

$q_murid = oci_parse($conn_sispa,"SELECT * FROM markah_pelajar mkh, tnilai_smr mr WHERE mkh.kodsek='$kodsek' and mkh.nokp=mr.nokp 
 AND 
 mkh.tahun=mr.tahun and mkh.kodsek=mr.kodsek
and mkh.ting=mr.ting and mkh.kelas=mr.kelas and mkh.jpep=mr.jpep 
AND mkh.tahun='$tahun' AND mkh.ting='$ting' AND mkh.kelas='$kelas' AND mkh.jpep='$jpep' ORDER BY mr.keputusan Desc, mr.gpc ASC, mr.peratus DESC");
oci_execute($q_murid);
$bilmurid = count_row("SELECT * FROM markah_pelajar mkh, tnilai_smr mr WHERE mkh.kodsek='$kodsek' and mkh.nokp=mr.nokp AND 
 mkh.tahun=mr.tahun and mkh.kodsek=mr.kodsek
and mkh.ting=mr.ting and mkh.kelas=mr.kelas and mkh.jpep=mr.jpep and 
mkh.tahun='$tahun' AND mkh.ting='$ting' AND mkh.kelas='$kelas' AND mkh.jpep='$jpep' ORDER BY mr.keputusan Desc, mr.gpc ASC, mr.peratus DESC");*/
$q_mkdt = oci_parse($conn_sispa,"SELECT * FROM markah_pelajar mkh, tnilai_smr mr WHERE 
mkh.kodsek='$kodsek' and mkh.nokp=mr.nokp and
 mkh.tahun=mr.tahun and mkh.kodsek=mr.kodsek
and mkh.ting=mr.ting and mkh.kelas=mr.kelas and mkh.jpep=mr.jpep
...
//$q_sub = oci_parse($conn_sispa,"SELECT * FROM mpsmkc mp, sub_guru sg WHERE sg.kodsek='$kodsek' and sg.tahun='$tahun' AND sg.ting='$ting' AND sg.kelas='$kelas' AND mp.kod=sg.kodmp ORDER BY mp.kod");
