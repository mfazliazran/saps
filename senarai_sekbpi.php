...
<p class="subHeader">Senarai Sekolah [Bahagian Pendidikan Islam]</p>
<?php 
...
<?php
echo "<br>";
echo "<center><h3>SENARAI SEKOLAH BPI (SR/SM Agama-SABK, SMK Agama)  </center></h3><br>";
...
<?php
paging($totalrecord,$recordpage,"senarai_sekbpi.php?cari=1",$pg);
