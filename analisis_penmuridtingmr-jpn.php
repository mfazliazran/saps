...
<form action="ctk_analisis_penmuridtingmr-jpn.php?ting=<?php echo $ting;?>" method="POST" target="_blank">
...
$q_nting = "SELECT *  FROM tnilai_smr mr, tmurid tm WHERE mr.kodsek='$kodsek' and mr.tahun='$tahun' AND mr.jpep='$jpep' AND mr.ting='$ting' AND mr.nokp=tm.nokp and kodsek_semasa='$kodsek' ORDER BY mr.keputusan ASC, mr.gpc ASC, mr.peratus DESC";
...
<input type="button" name="export" value="EXPORT KE EXCEL" onclick="open_window('data-analisis_penmuridtingmr-excel-jpn.php?ting=<?php echo $m;?>','win1');" />
</form>
