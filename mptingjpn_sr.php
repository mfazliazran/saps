...
<?php
echo "<h5><center>$namappd<br>ANALISA MATA PELAJARAN TAHUN $ting<br>".jpep("$jpep")."<br>TAHUN ".$_SESSION['tahun']."</center></h5>";
...
?>
<br><br>
&nbsp;&nbsp;<input type="button" name="cetak" value="CETAK" onClick="document.f1.action='ctk_mptingsrjpn.php?<?php echo "ting=$ting&tahun=$tahun&jpep=$jpep";?>';document.f1.submit();">
<input type="button" name="export" value="EXPORT KE EXCEL" onclick="document.f1.action='mptingsrjpn_excel.php?<?php echo "ting=$ting&tahun=$tahun&jpep=$jpep";?>';document.f1.submit();" />
</form> 
