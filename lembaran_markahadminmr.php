...
<form action="ctk_lembaran-markahadminmr.php?ting=<?php echo $m;?>" method="POST" target="_blank">
...
<input type="button" name="export" value="EXPORT KE EXCEL" onclick="open_window('data-markah-adminmr-excel.php?ting=<?php echo $m;?>','win1');" />
</form>
<?php 
include 'kaki.php';
function tahap($ting)
