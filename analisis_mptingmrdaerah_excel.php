...
header('Content-Disposition: attachment; filename="mpting_daerahmr.xls"');
...
$bilmp = count_row("SELECT amp.kodmp, mp.mp, SUM(bcalon) bcalon, SUM(ambil) ambil, SUM(TH) th, SUM(A) bila, SUM(B) bilb, SUM(C) bilc, SUM(D) bild, SUM(E) bile, SUM(F) bilf FROM analisis_mpmr amp, mpsmkc mp,tsekolah ts WHERE amp.tahun='$tahun' AND amp.kodsek=ts.kodsek AND amp.jpep='$jpep' AND  amp.ting='$ting' AND amp.kodmp=mp.kod and ts.kodppd='$kodppd' Group BY amp.kodmp,mp.mp ORDER BY amp.kodmp ");
//echo "$bilmp ";
...
$bilmp = count_row("SELECT amp.kodmp, mp.mp, SUM(bcalon) bcalon, SUM(ambil) ambil, SUM(TH) th, SUM(A) bila, SUM(B) bilb, SUM(C) bilc, SUM(D) bild, SUM(E) bile FROM analisis_mpmr amp, mpsmkc mp,tsekolah ts WHERE amp.tahun='$tahun' AND amp.kodsek=ts.kodsek AND amp.jpep='$jpep' AND  amp.ting='$ting' AND amp.kodmp=mp.kod and ts.kodppd='$kodppd' Group BY amp.kodmp,mp.mp ORDER BY amp.kodmp ");
//echo "$bilmp ";
