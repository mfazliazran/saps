...
//echo "SELECT * FROM tguru_kelas gk, tsekolah ts WHERE gk.tahun='".$_SESSION['tahun']."' AND gk.kodsek='".$_SESSION['kodsek']."' AND gk.ting='$ting' AND gk.kelas='".oci_escape_string($kelas)."' AND gk.kodsek=ts.kodsek";
OCIExecute($q_guru);
OCIFetch($q_guru);
