...
$m="$ting&kelas=".urlencode($kelas)."";//&&namaguru=$namagu&&tingkatan=$tingkatan";//&&namasekolah=$namasek";
//die($m);
...
<form action="ctk_lembaran-markahadminma-jpn.php?ting=<?php echo $m;?>" method="POST" target="_blank">
...
<input type="button" name="export" value="EXPORT KE EXCELL" onclick="open_window('data-markah-adminma-excel-jpn.php?ting=<?php echo $m;?>','win1');" />
</form>
