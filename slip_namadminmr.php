...
echo "<th width=\"100%\" scope=\"col\" ><a href=slip-allmr.php?data=".$ting."|".urlencode($kelas)." target=_blank><center><img src = images/printer.png width=25 height=25 border=\"0\"><br>Cetak Semua</center></a></th>\n";
echo "</table>";
...
while ($row = oci_fetch_array($q_slip))
{
	...
	echo "    <td><a href=slipmr.php?data=".urlencode($nokp)."|".$ting."|".urlencode($kelas)." target=_blank><center><img src = images/printer.png width=13 height=13 Alt=\"Cetak\" border=0></center></a></td>\n";
	...
	echo "    <td><a href=slipmuridmr_excel.php?data=".urlencode($nokp)."|".$ting."|".urlencode($kelas)." target=_blank><center><img src = images/printer.png width=13 height=13 Alt=\"Cetak\" border=0></center></a></td>\n";
...
echo "<br><br>";
?>
<input type="button" name="export" value="EXPORT KE EXCEL" onclick="open_window('slipallmr_excel.php?data=<?php echo $m;?>','win1');" /></center>
<?php
echo "<br><br><br>";
