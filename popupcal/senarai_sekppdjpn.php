...
<?php if ($_SESSION["level"]=="5") { ?>
  <p class="subHeader">Senarai Sekolah [Bahagian Pejabat Pelajaran Daerah]</p>
<?php } else { ?>
...
if ($_SESSION["level"]=="5")
   $query_sm = " SELECT KodSek,NamaSek FROM tsekolah where kodppd = '".$_SESSION["kodsek"]."'";
else
   $query_sm = " SELECT KodSek,NamaSek FROM tsekolah where kodnegerijpn = '".$_SESSION["kodsek"]."'";
...
<?php
paging($totalrecord,$recordpage,"senarai_sekppdjpn.php?cari=1",$pg);
