...
$q_mp = "SELECT amp.kodmp,mp.mp, SUM(bcalon) bcalon, SUM(ambil) ambil, SUM(TH) th, SUM(A) bila, SUM(B) bilb, SUM(C) bilc, SUM(D) bild, SUM(E) bile, SUM(F) bilf FROM analisis_mpsr amp, mpsr mp WHERE amp.kodsek='$kodsek' and amp.tahun='$tahun' AND amp.jpep='$jpep' AND  amp.darjah='$ting' AND amp.kodmp=mp.kod Group BY mp.susun,mp.mp, amp.kodmp ORDER BY mp.susun ";
