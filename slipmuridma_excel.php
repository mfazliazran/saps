...
//include 'menu.php';
   ...
   header('Content-Disposition: attachment; filename="slipmuridma.xls"');
...
//echo "SELECT * FROM markah_pelajar mkh, tnilai_sma ma WHERE mkh.nokp=ma.nokp AND mkh.tahun=ma.tahun and mkh.kodsek=ma.kodsek
...
//echo "SELECT * FROM markah_pelajar mkh , tnilai_sma ma WHERE mkh.nokp='$nokp' AND ma.nokp='$nokp' AND mkh.tahun=ma.tahun and mkh.kodsek=ma.kodsek and mkh.ting=ma.ting and mkh.kelas=ma.kelas and mkh.jpep=ma.jpep AND mkh.nokp='$nokp' and mkh.tahun='$tahun' AND mkh.kodsek='$kodsek' AND mkh.ting='$ting' AND mkh.kelas='$kelas' AND mkh.jpep='$jpep'";
oci_execute($q_slip);
...
echo "<br>\n";
echo "<center><b><strong>SLIP KEPUTUSAN - ".jpep($jpep)." - $tahun</strong></font></b></center>";
echo "<br>\n";
