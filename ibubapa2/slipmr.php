...
if($_SESSION["tahun_semasa"]<>"")
	...
	$tahun = date("Y");
//echo "$nokp $kodsek $ting $kelas $jpep $tahun";
...
$wujud = "0";
$res2 = OCIParse($conn_sispa,"SELECT count(nokp) as BILREKOD FROM tnilai_smr WHERE nokp= :nokp and kodsek= :kodsek and tahun= :tahun and ting= :ting AND jpep= :jpep");
...
if($wujud==0){
	$qrytingkatan = "SELECT * FROM tmurid WHERE kodsek$ting=:kodsek AND $ting=:ting and kelas$ting=:kelas and tahun$ting=:tahun";	
}else{
	$qrytingkatan = "SELECT * FROM markah_pelajar mkh, tnilai_smr mr WHERE mkh.nokp=mr.nokp AND mkh.tahun=mr.tahun and mkh.kodsek=mr.kodsek and mkh.ting=mr.ting and mkh.kelas=mr.kelas and mkh.jpep=mr.jpep AND mkh.tahun=:tahun AND mkh.kodsek=:kodsek AND mkh.ting=:ting AND mkh.jpep=:jpep";
}
$bilting=0;
...
if($wujud==0){
	...
	$q_slip = oci_parse($conn_sispa,"SELECT * FROM markah_pelajar mkh, tnilai_smr mr WHERE mkh.nokp=:nokp AND mr.nokp=:nokp AND mkh.tahun=mr.tahun and mkh.kodsek=mr.kodsek and mkh.ting=mr.ting and mkh.kelas=mr.kelas and mkh.jpep=mr.jpep AND mkh.tahun=:tahun AND mkh.kodsek=:kodsek AND mkh.ting=:ting AND mkh.jpep=:jpep");
}
...
$bilmurid=0;
$qmurid = "SELECT * FROM markah_pelajar mkh, tnilai_smr mr WHERE mkh.nokp=mr.nokp AND mkh.tahun=mr.tahun and mkh.kodsek=mr.kodsek and mkh.ting=mr.ting and mkh.kelas=mr.kelas and mkh.jpep=mr.jpep AND mkh.tahun=:tahun AND mkh.kodsek=:kodsek AND mkh.ting=:ting AND mkh.kelas=:kelas_lama AND mkh.jpep=:jpep";
