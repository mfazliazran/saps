...
<p class="subHeader">Pindah Pengguna</p>
...
if ($_POST["post"]=="1"){
  ...
  $query_sm=" update login set kodsek='$kodsekpindah',namasek='$namasekpindah',statussek='$statussek',kodnegeri='$kodnegeri',
  negeri='$negeri',daerah='$daerah',level1='$level_baru'  where nokp='$nokp'";
