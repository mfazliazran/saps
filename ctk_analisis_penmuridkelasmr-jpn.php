...
$q_nilai = "SELECT *  FROM tnilai_smr mr, tmurid tm WHERE mr.kodsek='$kodsek' AND mr.tahun='$tahun' AND mr.jpep='$jpep' AND mr.ting='$ting' AND mr.kelas='$kelas' AND mr.nokp=tm.nokp ORDER BY mr.keputusan Asc, mr.gpc Asc, mr.peratus Desc";
