<?php
setcookie("HTTPSERVERID", "", time()-3600);
...
//include("under.php");
//die();
//die("sistem saps sedang diselenggara sehingga 6.00am 18 Jun 2013. sebarang kesulitan amat dikesali.");
  //Start session
  ...
  include("include/kirapelawathome.php");
  ...
  $stmt=OCIParse($conn_sispa,"SELECT count(user1) as BIL from useronline");
  OCIExecute($stmt);
  if(OCIFetch($stmt))
...
<table width="1216"  align="center" border="0">
  ...
  <tr> 
    <td height="300"><font size="3" color="#FF0000"> <table width="1207" border="0">
        <tr> 
          <td width="204" valign="top"><table width="200" border="0">
              <tr> 
              ...
              <tr> 
                <td><a href="dokumen/Panduan Am Masalah SAPS.pdf" target="_blank"><img src="images/saps2012/faq.jpg" alt="" width="197" height="70" align="center"/></td>
              </tr>
              <tr> 
                <td><a href="ibubapa2/index.php" target="_blank"><img src="images/saps2012/ibubapa.jpg" alt="" width="197" height="70" align="left"/></td>
              </tr>
            </table></td>
          <td width="505" valign="top"><table width="496" align="right" height="133" border="0">
              <tr> 
          ...
          <td width="484" valign="top"><table width="437" align="center" height="307" border="0">
              <tr> 
                <td height="36" align="right" colspan="3"><img src="images/saps2012/login.gif" alt="" width="384" height="31"></td>
              </tr>
              <tr> 
                    ...
                    <tr> 
                      <td><font size="1" color="#FFFFFF"> 
                        <center>
                          ...
                          Resolution 1280 x 1024</font> <font style="color:transparent"> 
                          <?php
  //AMRAN140203-simple screen clue to see if load balancing is working.   
  echo substr(gethostbyname(gethostname()),-2,2);
  //AMRAN140203-end
?>
                          </font> 
                        </center>
