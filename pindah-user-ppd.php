...
<p class="subHeader">Pindah Pengguna Level PPD</p>

<?php
if(!($_SESSION["level"]=="5" and $_SESSION["pentadbir"]=="1")){
...
if ($_POST["post"]=="1"){
  ...
  kodnegeri='$kodnegeri',negeri='$negeri',daerah='$daerah',level1='$level_baru'  where nokp='$nokp'";
  //die($query_sm);
