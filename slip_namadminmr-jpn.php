...
//echo "<th width=\"100%\" scope=\"col\" ><a href=slip-allmr.php?data=".$kodsek."|".$ting."|".urlencode($kelas)."|".$tahun."|".$jpep."|".$lencana." target=_blank><center><img src = images/printer.png width=25 height=25 border=\"0\"><br>Cetak Semua</center></a></th>\n";
echo "<th width=\"100%\" scope=\"col\" ><a href=slip-allmr-jpn.php?data=".$ting."|".urlencode($kelas)." target=_blank><center><img src = images/printer.png width=25 height=25 border=\"0\"><br>Cetak Semua</center></a></th>\n";
echo "</table>";
...
while ($row = oci_fetch_array($q_slip))
{
	...
	//if($kodsek=='JEA1068')
		//echo "$kehadiran $kehadiranpenuh<br>";
	$bil=$bil+1;
	if($bil&1) {
		$bcol = "#CDCDCD";
	} else {
	...
	//echo "    <td><a href=slipmr.php?data=".$nokp."|".$kodsek."|".$ting."|".$kelas."|".$tahun."|".$jpep."|".$lencana." target=_blank><center><img src = images/printer.png width=13 height=13 Alt=\"Cetak\" border=0></center></a></td>\n";
	echo "    <td><a href=slipmr-jpn.php?data=".urlencode($nokp)."|".$ting."|".urlencode($kelas)." target=_blank><center><img src = images/printer.png width=13 height=13 Alt=\"Cetak\" border=0></center></a></td>\n";
			
	//echo "    <td><a href=slipmuridmr_excel.php?data=".$nokp."|".$kodsek."|".$ting."|".$kelas."|".$tahun."|".$jpep."|".$lencana." target=_blank><center><img src = images/printer.png width=13 height=13 Alt=\"Cetak\" border=0></center></a></td>\n";
	echo "    <td><a href=slipmuridmr_excel-jpn.php?data=".urlencode($nokp)."|".$ting."|".urlencode($kelas)." target=_blank><center><img src = images/printer.png width=13 height=13 Alt=\"Cetak\" border=0></center></a></td>\n";
...
echo "<br><br>";
?>
<input type="button" name="export" value="EXPORT KE EXCEL" onclick="open_window('slipallmr_excel-jpn.php?data=<?php echo $m;?>','win1');" /></center>
<?php
echo "<br><br><br>";
