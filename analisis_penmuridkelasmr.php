...
<form action="ctk_analisis_penmuridkelasmr.php?ting=<?php echo $m2;?>" method="POST" target="_blank">
...
$q_nilai = "SELECT tm.namap, mr.bilmp, mr.bila, mr.bilb, mr.bilc, mr.bilc, mr.bild, mr.bile, mr.bilf, mr.bilth, mr.jummark, mr.peratus, mr.keputusan, mr.gpc, mr.kdk, mr.pencapaian  FROM tnilai_smr mr, tmurid tm WHERE mr.kodsek='$kodsek' AND mr.tahun='$tahun' AND mr.jpep='$jpep' AND mr.ting= :ting AND mr.kelas= :kelas AND mr.nokp=tm.nokp and kodsek_semasa='$kodsek' GROUP BY tm.namap, mr.bilmp, mr.bila, mr.bilb, mr.bilc, mr.bilc, mr.bild, mr.bile, mr.bilf, mr.bilth, mr.jummark, mr.peratus, mr.keputusan, mr.gpc, mr.kdk, mr.pencapaian ORDER BY mr.keputusan Asc, mr.gpc Asc, mr.peratus Desc";
...
<input type="button" name="export" value="EXPORT KE EXCEL" onclick="open_window('data-analisis_penmuridkelasmr-excel.php?ting=<?php echo $m;?>','win1');" />
</form>
