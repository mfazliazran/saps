...
{		
	...
	switch ($ting)
	{
		case "D1": case "D2" : case "D3": case "D4" :case "D5" : case "D6" :
			location("near_misssr-jpn.php?ting=$ting&&kelas=$kelas");//&&namaguru=$namagu&&tingkatan=$tingkatan&&namasekolah=$namasek");
			break;
		case "P": case "T1": case "T2": case "T3":
			location("near_missmr-jpn.php?ting=$ting&&kelas=$kelas");//&&namaguru=$namagu&&tingkatan=$tingkatan&&namasekolah=$namasek");
			break;
		case "T4": case "T5":
			location("near_missma-jpn.php?ting=$ting&&kelas=$kelas");//&&namaguru=$namagu&&tingkatan=$tingkatan&&namasekolah=$namasek");
			break;
	}
} 
else {
		...
		self.location='near_miss_pilih-jpn.php?ting=' + val;
		}
		</script>
		<?php
		...
		echo "<form method=post name='f1' action='near_miss_pilih-jpn.php'>";
