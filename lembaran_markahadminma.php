...
<form action="ctk_lembaran-markahadminma.php?ting=<?php echo $m;?>" method="POST" target="_blank">
...
<input type="button" name="export" value="EXPORT KE EXCEL" onclick="open_window('data-markah-adminma-excel.php?ting=<?php echo $m;?>','win1');" />
</form>
