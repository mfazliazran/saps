...
{
	location.href="mpep-sekall_ind.php?status=" + status
}
...
function pilih_tahun(tahun_semasa,status1)
{
	...
	location.href="mpep-sekall_ind.php?status=" + status1 + "&tahunpep=" + tahun_semasa +"&pep=" + pep
}
</script>
...
if ($statussek1=="SM"){
	echo "<h3><center>ANALISIS PENCAPAIAN MATA PELAJARAN ".$_SESSION["tahun"]."</center></h3><br>";
   	echo "<form method='post' name='f1' action='mp-sekolah_ind.php' target=\"_blank\">";
