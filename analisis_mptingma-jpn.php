...
<form action="ctk_analisis-mptingma-jpn.php?ting=<?php echo $ting;?>" method="POST" target="_blank">
<?php
...
<input type="button" name="export" value="EXPORT KE EXCEL" onclick="open_window('data-analisis-mptingma-excel-jpn.php?ting=<?php echo $m;?>','win1');" />
</form>
