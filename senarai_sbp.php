...
<p class="subHeader">Senarai Sekolah Berasrama Penuh</p>
<?php 
...
<?php
echo "<br>";
echo "<center><h3>SENARAI SEKOLAH BERASRAMA PENUH</center></h3><br>";
...
<?php
paging($totalrecord,$recordpage,"senarai_sbp.php?cari=1",$pg);
