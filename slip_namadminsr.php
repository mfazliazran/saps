...
echo "<th width=\"100%\" scope=\"col\"><center><a href=slip-allsr.php?data=".$kodsek."|".$ting."|".urlencode($kelas)."|".$tahun."|".$jpep."|".$lencana." target=_blank><img src = images/printer.png width=25 height=25 border=\"0\"><br>Cetak Semua</center></a></th>\n";
echo "  <tr>\n";
echo "</table>";
...
while ($row = oci_fetch_array($q_slip))
{
	...
	echo "    <td><a href=slipsr.php?data=".urlencode($nokp)."|".$kodsek."|".$ting."|".urlencode($kelas)."|".$tahun."|".$jpep."|".$lencana." target=_blank><center><img src = images/printer.png width=13 height=13 Alt=\"Cetak\" border=0></center></a></td>\n";
	
	echo "    <td><a href=slipmuridsr_excel.php?data=".urlencode($nokp)."|".$kodsek."|".$ting."|".urlencode($kelas)."|".$tahun."|".$jpep."|".$lencana." target=_blank><center><img src = images/printer.png width=13 height=13 Alt=\"Cetak\" border=0></center></a></td>\n";
...
echo "</table></body>\n";
?>
<input type="button" name="export" value="EXPORT KE EXCEL" onclick="open_window('slipallsr_excel.php?data=<?php echo $m;?>','win1');" /></center>
<?php
echo "<br><br><br>";
include 'kaki.php';
?> 