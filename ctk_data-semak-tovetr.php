...
if ($kelas[$i] <> $kls){
	...
	echo "	<td rowspan =\"$num[$baris]\"><center>$ting&nbsp;&nbsp;&nbsp; $kelas[$i] <br>[$bilmurid[$i] Murid]</center></td>";
...
if(($bil_mark[$i] == $bil_etr[$i]) AND ($bil_mark[$i] !=0) AND ($bil_etr[$i] == $bilammp[$i])){
					echo  "<td><center>$bil_mark[$i]</center></td><td><center>$bil_etr[$i]</center></td><td><center><img src=\"images/ok.png\" width=\"20\" height=\"20\"></center></td>";
					 $mpok = $mpok + 1;
				} else {
						echo  "<td><center>$bil_mark[$i]</center></td><td><center>$bil_etr[$i]</center></td><td><center><img src=\"images/ko.png\" width=\"20\" height=\"20\"></center></td>";
						}
