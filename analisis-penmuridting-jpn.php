...
{		
	...
	switch ($ting)
	{
		case "D1": case "D2" : case "D3": case "D4" :case "D5" : case "D6" :
			location("analisis_penmuridtingsr-jpn.php?ting=$ting");//&&namasekolah=$namasek");
			break;
		case "P": case "T1": case "T2": case "T3":
			location("analisis_penmuridtingmr-jpn.php?ting=$ting");//&&namasekolah=$namasek");
			break;
		case "T4": case "T5":
			location("analisis_penmuridtingma-jpn.php?ting=$ting");//&&namasekolah=$namasek");
			break;
	}
}
else{
