...
<form action="ctk_penmuridtingma.php?ting=<?php echo $ting;?>" method="POST" target="_blank">
...
<input type="button" name="export" value="EXPORT KE EXCEL" onclick="open_window('data-penmuridtingma-excel.php?ting=<?php echo $m;?>','win1');" />
</form>
