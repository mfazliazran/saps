...
while($data=oci_fetch_array($w_kelas)){
	$kelas = $data["KELAS"];
	$bilambil = count_row("select from tmurid where kodsek$ting='$kodsek' and tahun$ting='$tahun' and $ting='$ting' and kelas$ting='$kelas'");
	$sql_nilai = "select * from tnilai_smr where kodsek='$kodsek' and tahun='$tahun' and ting='$ting' and kelas='$kelas'";
