...
$c = $_GET['data'];
//list ($kodsek, $ting, $kelas, $tahun, $jspep) =split('[|]', $c);
...
if($level=="MA"){
	...
	$q_murid = "SELECT * FROM tmurid WHERE kodsek$gting='$kodsek' AND $gting='$ting' AND kelas$gting='$kelas' AND tahun$gting='$tahun' and kodsek_semasa='$kodsek' ORDER BY namap"; 
	$stmt = oci_parse($conn_sispa,$q_murid);
	oci_execute($stmt);
	
	$bil_pel = count_row("SELECT * FROM tmurid WHERE kodsek$gting='$kodsek' AND $gting='$ting' AND kelas$gting='$kelas' AND tahun$gting='$tahun' and kodsek_semasa='$kodsek' ORDER BY namap");
...
$bil_ting = count_row($q_nting);
	...
	while ($row = oci_fetch_array($stmt))
	{
		...
		while($rowsub = oci_fetch_array($q_sub)){
			$kodmp=$rowsub["KODMP"];
			$gmp="G$kodmp";
			$t_mark = "SELECT $kodmp, $gmp,kehadiran,kehadiranpenuh,ulasan FROM markah_pelajar WHERE nokp='$nokp' AND tahun='$tahun' AND kodsek='$kodsek' AND ting='$ting' AND kelas='$kelas' AND jpep='$jspep' ";
			...
			while($row_mark=oci_fetch_array($stmt1)){
				$kehadiran = $row_mark["KEHADIRAN"];
				$kehadiranpenuh = $row_mark["KEHADIRANPENUH"];
				$ulas = $row_mark['ULASAN'];
		...
		$q_nilai = oci_parse($conn_sispa,"SELECT * FROM tnilai_sma WHERE nokp='$nokp' AND tahun='$tahun' AND kodsek='$kodsek' AND ting='$ting' AND kelas='$kelas' AND jpep='$jspep'");
		oci_execute($q_nilai);
		...
		//$panggil = "SELECT ulasan FROM markah_pelajar WHERE nokp='$nokp' AND tahun='$tahun' AND kodsek='$kodsek' AND kelas='$kelas' AND jpep='$jspep'";
...
if($level=="MR"){
	$kodsekolah = "kodsekp='$kodsek' OR kodsekt1='$kodsek' OR kodsekt2='$kodsek' OR kodsekt3='$kodsek' OR kodsekt4='$kodsek' OR kodsekt5='$kodsek'"; 
	$q_murid = "SELECT * FROM tmurid WHERE kodsek$gting='$kodsek' AND tahun$gting='$tahun' AND $gting='$ting' AND kelas$gting='$kelas' and kodsek_semasa='$kodsek' ORDER BY namap";
	$stmt5 = oci_parse($conn_sispa,$q_murid);
	oci_execute($stmt5);
	$bil_pel = count_row("SELECT * FROM tmurid WHERE kodsek$gting='$kodsek' AND tahun$gting='$tahun' AND $gting='$ting' AND kelas$gting='$kelas' and kodsek_semasa='$kodsek' ORDER BY namap");
	//$bil_ting=count_row("SELECT * FROM tmurid WHERE tahun$gting='$tahun' AND $gting='$ting' AND ($kodsekolah)");
...
$bil_ting = count_row($q_nting);
	...
	while ($row = oci_fetch_array($stmt5))
	{
		...
		while($rowsub = oci_fetch_array($q_sub)){
			$kodmp=$rowsub["KODMP"];
			$gmp="G$kodmp";
			$t_mark = "SELECT $kodmp, $gmp FROM markah_pelajar WHERE nokp='$nokp' AND tahun='$tahun' AND kodsek='$kodsek' AND ting='$ting' AND kelas='$kelas' AND jpep='$jspep' ";
		...
		//$q_nilai = oci_parse($conn_sispa,"SELECT * FROM penilaian_muridsmr WHERE nokp='$nokp' AND tahun='$tahun' AND kodsek='$kodsek' AND ting='$ting' AND kelas='$kelas' AND jpep='$jspep'");
		//echo "SELECT * FROM penilaian_muridsmr WHERE nokp='$nokp' AND tahun='$tahun' AND kodsek='$kodsek' AND ting='$ting' AND kelas='$kelas' AND jpep='$jspep'";
...
and mkh.ting=mr.ting and mkh.kelas=mr.kelas and mkh.jpep=mr.jpep 					
					AND mkh.tahun='$tahun' AND mkh.kodsek='$kodsek' AND mkh.ting='$ting' AND mkh.kelas='$kelas' AND mkh.jpep='$jspep'");
		oci_execute($q_nilai);
		$row_result=oci_fetch_array($q_nilai);
...
if($level=="SR"){
	...
	$gting=strtoupper($ting);
	$q_murid = "SELECT * FROM tmuridsr WHERE kodsek$gting='$kodsek' AND tahun$gting='$tahun' AND $gting='$ting' AND kelas$gting='$kelas' and kodsek_semasa='$kodsek' ORDER BY namap";
	$stmt8 = oci_parse($conn_sispa,$q_murid);
	oci_execute($stmt8);
	$bil_pel=count_row("SELECT * FROM tmuridsr WHERE kodsek$gting='$kodsek' AND tahun$gting='$tahun' AND $gting='$ting' AND kelas$gting='$kelas' and kodsek_semasa='$kodsek' ORDER BY namap");
	//$bil_darjah=count_row("SELECT * FROM tmuridsr WHERE tahun$gting='$tahun' AND $gting='$ting' AND ($kodsekolah)");
	$q_nting = "SELECT *  FROM tnilai_sr sr, tmuridsr tm WHERE sr.tahun='$tahun' AND sr.jpep='$jspep' AND sr.darjah='$ting' AND sr.kodsek='$kodsek' AND sr.nokp=tm.nokp and kodsek_semasa='$kodsek' ORDER BY sr.keputusan Desc, sr.gpc Asc, sr.peratus Desc";
...
$bil_darjah = count_row($q_nting);
	...
	while ($row = oci_fetch_array($stmt8))
	{
		...
		while($rowsub = oci_fetch_array($q_sub)){
			...
			$t_mark = "SELECT $kodmp, $gmp , KEHADIRAN FROM markah_pelajarsr WHERE nokp='$nokp' AND tahun='$tahun' AND kodsek='$kodsek' AND darjah='$ting' AND kelas='$kelas' AND jpep='$jspep' ";
		...
		//$q_nilai = oci_parse($conn_sispa,"SELECT * FROM penilaian_muridsr WHERE nokp='$nokp' AND tahun='$tahun' AND kodsek='$kodsek' AND darjah='$ting' AND kelas='$kelas' AND jpep='$jspep'");
...
and mkh.darjah=sr.darjah and mkh.kelas=sr.kelas and mkh.jpep=sr.jpep and
					sr.nokp='$nokp' AND mkh.tahun='$tahun' AND mkh.kodsek='$kodsek' AND mkh.darjah='$ting' AND mkh.kelas='$kelas' AND mkh.jpep='$jspep'");
		oci_execute($q_nilai);
		$row_result=oci_fetch_array($q_nilai);
		echo "</table>\n";
		echo "<br>\n";
