...
////////////////////////////////////////////////////////////////////////
	...
	//echo "SELECT * FROM tentu_hc WHERE tahunpep='$tahun' AND tingpep='$ting' AND capai='TOV'";
	oci_execute($qtov);
	...
	while ($rowmp = oci_fetch_array($qsubsek)){
		...
		//$qhcmurid = mysql_query("SELECT * FROM $theadcount WHERE tahun='$tahun' AND kodsek='$kodsek' AND $tahap='$ting' AND hmp='$subsek'") or die('Error, salah guery headcount');
		...
		echo "<td><a href=semak-hc-mp-jpn.php?data=".$ting."|".$subsek." target=_blank><div align=\"left\">$namamp</div></td>\n";
