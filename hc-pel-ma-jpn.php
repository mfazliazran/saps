...

{
		...
		//die("SELECT * FROM $tmatap WHERE kod='$mp'");
		OCIExecute($qnamamp);
		OCIFetch($qnamamp);
		...
		if(($ting !='') AND($mp != '')) {
			...
			echo " <td><b>SEKOLAH :</b> $namasek</td>\n";

			echo "  </tr>\n";

			echo " <td><b>$tajuk :</b> $ting</td>\n";
...
////////////////////////////////////////// BLOK MENENGAH RENDAH & SEKOLAH RENDAH  ///////////////////////////////////////////////////////////
		...
		if (($level=="MR") OR ($level=="SR")){
			...
			$qbcalon = "SELECT * FROM $theadcount WHERE tahun='$tahun' AND kodsek='$kodsek' AND $tahap='$ting' AND hmp='$mp'";
			...
			while (OCIFetch($qbc))
			{
				...
				switch (/*$rowhc['gotr1']*/OCIResult($qbc,"GOTR1"))
				{
				...
				switch (/*$rowhc['gotr2']*/OCIResult($qbc,"GOTR2"))
				{
				...
				switch (/*$rowhc['gotr3']*/OCIResult($qbc,"GOTR3"))
				{
				...
				switch (/*$rowhc['getr']*/OCIResult($qbc,"GETR"))
				{
			...
			$jpepatr1=OCIResult($qrytentuhcatr1,"JENPEP")/*$rowtentuatr1['jenpep']*/; $tahunatr1=OCIResult($qrytentuhcatr1,"TAHUNTOV")/*$rowtentuatr1['tahuntov']*/; $tingatr1=/*$rowtentuatr1['tingtov']*/OCIResult($qrytentuhcatr1,"TINGTOV");
			$qryatr1 = "SELECT * FROM $tmarkah WHERE kodsek='".$_SESSION['kodsek']."' AND $tahap='$tingatr1' AND jpep='$jpepatr1' AND tahun='$tahunatr1' AND $mp IS NOT NULL";// $mp!=''";
			//if($kodsek='BEA8638')
				//echo $qryatr1."<br>";
			...
			while (OCIFetch($qry))
			{
				switch (OCIResult($qry,"$gmp")/*$rowatr1["$gmp"]*/)
				{
			...
			OCIExecute($qry2);
			OCIFetch($qry2);	
			$jpepatr2=/*$rowtentuatr2['jenpep']*/OCIResult($qry2,"JENPEP"); 
			$tahunatr2=/*$rowtentuatr2['tahuntov']*/OCIResult($qry2,"TAHUNTOV"); 
			$tingatr2=/*$rowtentuatr2['tingtov']*/OCIResult($qry2,"TINGTOV");
			$qryatr2 =  "SELECT * FROM $tmarkah WHERE kodsek='".$_SESSION['kodsek']."' AND $tahap='$tingatr2' AND jpep='$jpepatr2' AND tahun='$tahunatr2' AND $mp IS NOT NULL";// $mp!=''";
			//if($kodsek=='RBA0021')
				//echo $qryatr2."<br>";
			...
			{
				switch (OCIResult($qry_2,"$gmp")/*$rowatr2["$gmp"]*/)
				{
			...
			$jpepatr3=/*$rowtentuatr3['jenpep']*/OCIResult($qrytentuhcatr3,"JENPEP"); 
			$tahunatr3=/*$rowtentuatr3['tahuntov']*/OCIResult($qrytentuhcatr3,"TAHUNTOV"); 
			$tingatr3=/*$rowtentuatr3['tingtov']*/OCIResult($qrytentuhcatr3,"TINGTOV");
			$qryatr3 = "SELECT * FROM $tmarkah WHERE kodsek='".$_SESSION['kodsek']."' AND tahun='$tahunatr3' AND $tahap='$tingatr3' AND jpep='$jpepatr3' AND $mp IS NOT NULL";// $mp!=''";
			...
			} else { $gpkatr1 = $peratusatr1A = $peratusatr1B = $peratusatr1C = $peratusatr1D = $peratusatr1L = $peratusatr1E =  0.00;  }
			...
			} else { $gpkatr2 = $peratusatr2A = $peratusatr2B = $peratusatr2C = $peratusatr2D = $peratusatr2L = $peratusatr2E =  0.00;  }
			...
			} else { $gpkatr3 = $peratusatr3A = $peratusatr3B = $peratusatr3C = $peratusatr3D = $peratusatr3L = $peratusatr3E =  0.00;  }
...
/////////////////////////////////////// ETR ///////////////////////////////
		...
		echo "<br><br>";
			...
			echo "      << <a href=\"hc-pel-ma-jpn.php\">Kembali</a></td>\n";
...
function reload(form)
{
	...
	self.location='hc-pel-ma-jpn.php?ting=' + val ;
}
</script>
<?php
	$ting=$_GET['ting'];
...
//	echo "<form method=\"post\">\n"; target=\"_blank\"
	echo "<form method=\"post\" action=\"hc-pel-ma-jpn.php\">";
