...
<p class="subHeader">Senarai Sekolah Kluster Kecermelangan</p>
<?php 
...
<?php
echo "<br>";
echo "<center><h3>SENARAI SEKOLAH KLUSTER KECERMELANGAN</center></h3><br>";
...
<?php
paging($totalrecord,$recordpage,"senarai_skk.php?cari=1",$pg);
