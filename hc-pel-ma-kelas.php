...
////////////////////////////////////////// BLOK MENENGAH RENDAH & SEKOLAH RENDAH  ///////////////////////////////////////////////////////////
		if (($level=="MR") OR ($level=="SR")){
			...
			$qryatr1 = "SELECT * FROM $tmarkah WHERE kodsek='".$_SESSION['kodsek']."' AND $tahap='$tingatr1' AND kelas='$kelas' AND jpep='$jpepatr1' AND tahun='$tahunatr1' AND $mp IS NOT NULL";// $mp!=''";
			//if($kodsek='BEA6601')
				//echo $qryatr1."<br>";
			...
			$qryatr2 = "SELECT * FROM $tmarkah WHERE kodsek='".$_SESSION['kodsek']."' AND $tahap='$tingatr2' AND kelas='$kelas' AND jpep='$jpepatr2' AND tahun='$tahunatr2' AND $mp IS NOT NULL";//$mp!=''";
			//if($kodsek='BEA8638')
				//echo $qryatr2."<br>";
			...
			$qryatr3 = "SELECT * FROM $tmarkah WHERE kodsek='".$_SESSION['kodsek']."' AND $tahap='$tingatr3' AND kelas='$kelas' AND jpep='$jpepatr3' AND tahun='$tahunatr3' AND  $mp IS NOT NULL";//$mp!=''";
			...
			if ($bilcalon != 0){
				$peratustovA = number_format(($biltovA/($bilcalon - $biltovTH))*100,2,'.',',');
			...
			if ($bilatr1 != 0){
				...
				$gpkatr1 = $peratusatr1A = $peratusatr1B = $peratusatr1C = $peratusatr1D = $peratusatr1L = $peratusatr1E = $peratusatr1F =  0.00;  
			}
			...
			if ($bilatr3 != 0){
				...
				$gpkatr3 = $peratusatr3A = $peratusatr3B = $peratusatr3C = $peratusatr3D = $peratusatr3L = $peratusatr3E = $peratusatr3F =  0.00;  
			}
			...
			echo "  <tr bgcolor=\"#FFCC99\"><td width=\"3%\"><div align=\"center\">Bil</div></td>\n";//A
...
if ($level=="MA"){
	...
	while(OCIFetch($qbc)) //$rowhc
	{
		...
		{	
			...
			$qryatr1 = "SELECT * FROM markah_pelajar WHERE kodsek='".$_SESSION['kodsek']."' AND $tahap='$tingatr1' AND kelas='$kelas' AND jpep='$jpepatr1' AND tahun='$tahunatr1' AND $mp IS NOT NULL";//$mp!=''";
			$qry = OCIParse($conn_sispa,$qryatr1);
			OCIExecute($qry);
			$bilatr1 = count_row($qryatr1);
			while (OCIFetch($qry))
			...
			$qryatr2 = "SELECT * FROM markah_pelajar WHERE kodsek='".$_SESSION['kodsek']."' AND $tahap='$tingatr2' AND kelas='$kelas' AND jpep='$jpepatr2' AND tahun='$tahunatr2' AND $mp IS NOT NULL";//$mp!=''";
			$qry2 = OCIParse($conn_sispa,$qryatr2);
			OCIExecute($qry2);
			$bilatr2 = count_row($qryatr2);
			while (OCIFetch($qry2))
			...
			$qryatr3 = "SELECT * FROM markah_pelajar WHERE kodsek='".$_SESSION['kodsek']."' AND $tahap='$tingatr3' AND kelas='$kelas' AND jpep='$jpepatr3' AND tahun='$tahunatr3' AND $mp IS NOT NULL";// $mp!=''";
			$qry3 = OCIParse($conn_sispa,$qryatr3);
			OCIExecute($qry3);
			$bilatr3 = count_row($qryatr3);
			while (OCIFetch($qry3))
		...
		echo "      << <a href=\"hc-pel-ma-kelas.php\">Kembali</a></td>\n";
...
self.location='hc-pel-ma-kelas.php?ting=' + val;
}
</script>
